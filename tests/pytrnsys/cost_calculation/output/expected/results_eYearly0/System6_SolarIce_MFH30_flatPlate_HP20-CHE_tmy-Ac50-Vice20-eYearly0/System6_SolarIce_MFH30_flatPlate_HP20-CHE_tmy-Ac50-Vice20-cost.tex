...
\hline \\ 
\hline \\ 
Annuity & Annuity (yearly costs over lifetime)  &&& & 12987$^{\mathrm{+2475}}_{\mathrm{-1696}}$ /a  \\
 & Share of Investment & &&& 7401$^{\mathrm{+1581}}_{\mathrm{-995}}$ /a (57$^{\mathrm{+23}}_{\mathrm{-16}}$\%) \\
 & Share of Electricity & 0+0.20/kWh & 21190 kWh &  & 4238$^{\mathrm{+764}}_{\mathrm{-647}}$ /a (33$^{\mathrm{+12}}_{\mathrm{- 9}}$\%)\\
 & Share of Maintenance & &&& 1348$^{\mathrm{+130}}_{\mathrm{-53}}$ /a (10$^{\mathrm{+ 3}}_{\mathrm{- 2}}$\%)\\ 
 & Share of Transmission grid & 50+50.00/kWh & 0 kWh & &  0 /a ( 0\%)\\
 & Share of Residual Value &&& &  0 /a ( 0\%)\\
Present Value  & Present Value of all costs  & &&& 244249.14$^{\mathrm{+23574.27}}_{\mathrm{-13372.04}}$ CHF \\
\hline \\ 
 Energy Generation Costs & Using annuity: &&& 26.35$^{\mathrm{+5.02}}_{\mathrm{-3.44}}$ & Rp./kWh \\
\hline
\hline
\end{tabular}
\end{adjustbox}
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=1\textwidth]{output/actual/results_eYearly0/System6_SolarIce_MFH30_flatPlate_HP20-CHE_tmy-Ac50-Vice20-eYearly0/costShare-System6_SolarIce_MFH30_flatPlate_HP20-CHE_tmy-Ac50-Vice20.pdf}
\caption{System cost}
\label{systemCost}
\end{center}
\end{figure}
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=1\textwidth]{output/actual/results_eYearly0/System6_SolarIce_MFH30_flatPlate_HP20-CHE_tmy-Ac50-Vice20-eYearly0/costShareAnnuity-System6_SolarIce_MFH30_flatPlate_HP20-CHE_tmy-Ac50-Vice20.pdf}
