...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=1\textwidth]{C:/Users/damian.birchler/src/pytrnsys/pytrnsys/tests/pytrnsys/cost_calculation/output/actual/results_json_files/HydD_mfb30Real_dryN/costShare-HydD_mfb30_real_dryN-CityBAS_dryNAc1.0x58.086Vice0.2x58.086HP1.0x18.442-Year0.pdf}
\caption{System cost}
\label{systemCost}
\end{center}
\end{figure}
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=1\textwidth]{C:/Users/damian.birchler/src/pytrnsys/pytrnsys/tests/pytrnsys/cost_calculation/output/actual/results_json_files/HydD_mfb30Real_dryN/costShareAnnuity-HydD_mfb30_real_dryN-CityBAS_dryNAc1.0x58.086Vice0.2x58.086HP1.0x18.442-Year0.pdf}
